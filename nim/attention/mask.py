...
def get_mask_token_index(mask_token_id, inputs):
    ...
    """
    # Get the list of token IDs from the 'input_ids' field in 'inputs'
    token_ids =inputs["input_ids"][0].numpy()
    
    # Loop through the list to find the mask_token_id
...
def visualize_attentions(tokens, attentions):
    ...
    for i, layer in enumerate(attentions):
        ...
        for k in range(len(layer[0])):
            ...
            # Generate a diagram for this specific head in the first layer
            generate_diagram(
                layer_number,
                head_number,
                tokens,
